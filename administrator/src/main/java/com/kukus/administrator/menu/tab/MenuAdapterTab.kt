...
class MenuAdapterTab(fm: FragmentManager) : FragmentPagerAdapter(fm) {
    ...
    init {
        ...
        mFragmentList.add(MenuList.newInstance(mTabText[0]))
        mFragmentList.add(MenuList.newInstance(mTabText[1]))
        mFragmentList.add(MenuList.newInstance(mTabText[2]))
