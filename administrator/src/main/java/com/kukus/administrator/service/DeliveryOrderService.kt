...
class DeliveryOrderService : Service(){

    val ACTION = "service.DeliveryOrderService"
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        ...
        if(intent?.getStringExtra("service_delivery").equals(ACTION)) {
            ...
            getShip(getDate).addChildEventListener(object : ChildEventListener {
                ...
                override fun onChildAdded(item: DataSnapshot, p1: String?) {
                    ...
                    if (ship != null) {
                        ...
                        when {
                            ship.status == STATUS.PENDING && ship.deliveryId == "" -> {
                                showNotification("Kukus Cairo", ship.ship_id, "New order #${ship.ship_id} Waiting to accept", R.drawable.ic_notification, ActivityOrders::class.java)
                            }
                        }
