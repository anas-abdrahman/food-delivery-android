...
class DialogMessageDelivery : DialogFragment() {

    @SuppressLint("CheckResult")
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {


        val viewRoot = inflater.inflate(R.layout.dialog_message_delivery, container, false)
        ...
        RxView.clicks(fab)
                ...
                .subscribe {
                    ...
                    getShip(getDate).child(id).child("message").push().setValue(
                            Message(key,
                                    "delivery",
                                    userId,
                                    "delivery",
