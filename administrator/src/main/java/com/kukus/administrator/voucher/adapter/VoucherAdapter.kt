package com.kukus.administrator.voucher.adapter
...
import com.kukus.administrator.voucher.DialogAddVoucher
...
class VoucherAdapter : RecyclerView.Adapter<VoucherAdapter.MyViewHolder>() {

    private var list: ArrayList<Voucher> = arrayListOf()
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.amount.text = ("LE " + list[position].amount)
    ...
    fun swapAdapter(list: ArrayList<Voucher>) {
        this.list = list
    }
