...
import kotlinx.android.synthetic.main.list_order_count.*
import org.jetbrains.anko.find
import org.jetbrains.anko.toast
import java.util.*


class DialogAddPromo : DialogFragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        viewRoot.find<Button>(R.id.submit).setOnClickListener {
            ...
            val promo = Promo(
                    ...
                    if(vCreate != 0.toLong()) vCreate else getTimestamp,
                    dateLong,
                    active.isChecked,
            ...
            getPromo(code.text.toString()).rxSetValue(promo).subscribe {
