...
public class CountriesAdapter extends ArrayAdapter<Country> implements SpinnerAdapter {
  ...
  public View getView(int position, View convertView, ViewGroup parent) {
    ...
    if (convertView == null) {
        ...
        convertView = mInflater.inflate(R.layout.spinner_flag_number, parent, false);

        ImageView imageView = (ImageView) convertView.findViewById(R.id.flag);
        TextView textView = (TextView) convertView.findViewById(R.id.code);

        //imageView.setImageResource(R.drawable.country_flag_eg);
